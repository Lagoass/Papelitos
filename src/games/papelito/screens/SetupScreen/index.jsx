...
// onExit: volta para a home do hub (fornecido pelo shell via módulo).
// Settings e InstallBanner agora vivem na HomeScreen do shell.
const SetupScreen = ({ onExit }) => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col p-6">
      {/* Header com título e volta para a home do hub */}
      <div className="relative mb-10">
        <h1 className="font-display text-4xl font-bold text-center tracking-tight">
